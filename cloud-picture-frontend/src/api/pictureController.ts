...
/** editPictureByBatch POST /api/picture/edit/picture */
export async function editPictureByBatchUsingPost(
  body: API.PictureEditByBatchRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/picture/edit/picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** listPictureVOByPageWitchCache POST /api/picture/list/page/vo/catch */
